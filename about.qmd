...
![](tabs/images/lidar.jpg){.rounded-img width="5in"}(https://www.yellowscan.com/knowledge/lidar-vs-photogrammetry-key-differences-and-applications/)
...
2.  MODIS
  ...
  ![](tabs/images/modis.jpg){.rounded-img width="290"}
...
3.  InSAR
  ...
  ![](tabs/images/InSAR.gif){.rounded-img}(https://www.usgs.gov/programs/VHP/insar-satellite-based-technique-captures-overall-deformation-picture)
...
4.  Landsat
  ...
  ![](tabs/images/landsat.jpg){.rounded-img width="5in"}
...
5.  Sentinel-2
  ...
  ![](tabs/images/Sentinel2.jpg){.rounded-img width="5in"}(https://earth.esa.int/eogateway/missions/landsat)
...
6.  Drones
  ...
  ![](tabs/images/drones.jpeg){.rounded-img width="5in"}(https://www.linkedin.com/pulse/what-different-types-sensors-used-uav-remote-sensing-ecko360-shvsc)
