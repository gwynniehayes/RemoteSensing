...
[![](lidar.jpg){.rounded-img width="5in"}](https://www.yellowscan.com/knowledge/lidar-vs-photogrammetry-key-differences-and-applications/)
...
[![](InSAR.jpeg){.rounded-img}](https://www.usgs.gov/programs/VHP/insar-satellite-based-technique-captures-overall-deformation-picture)
...
![](landsat.jpg){.rounded-img width="5in"}
...
[![](Sentinel2.jpg){.rounded-img width="5in"}](https://earth.esa.int/eogateway/missions/landsat)
...
[![](drones.jpeg){.rounded-img width="5in"}](https://www.linkedin.com/pulse/what-different-types-sensors-used-uav-remote-sensing-ecko360-shvsc)
